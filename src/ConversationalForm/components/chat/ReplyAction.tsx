...
const ReplyAction: React.FC<ReplyActionProps> = (props) => {
    return (
        <div className={getClassName(BASE_CLASS)}>
            <button className={getClassName(BASE_CLASS, ["ok"], [], "basicui-clean-button")} onClick={props.onSave}>
                OK
            ...
            <button className={getClassName(BASE_CLASS, ["cancel"], [], "basicui-clean-button")} onClick={props.onCancel}>
                ESC
                <SvgIcon height="16px" width="16px">
