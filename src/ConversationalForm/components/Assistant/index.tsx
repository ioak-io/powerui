...
import "./style.css";
import { Button, ButtonVariantType, IconButton, Input, Modal, ModalBody, ModalFooter, ModalHeader, ModalSizeType, SvgIcon, Textarea, ThemeType } from "basicui";
...
const Assistant = (props: AssistantProps) => {
    ...
    return (
        ...
        >
            ...
            <ModalFooter>
                <Button onClick={handleApply} variant={ButtonVariantType.transparent}>
                    Apply
                </Button>
